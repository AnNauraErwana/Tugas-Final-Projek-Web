<x-app-layout>
    <x-slot name="header">
        ...
        <div class="flex justify-between mb-4">
            <!-- Form Pencarian -->
            <form action="{{ route('buyer.products.index') }}" method="GET" class="flex space-x-2">
                ...
                <div class="overflow-hidden rounded-lg">
                    <template x-for="(image, index) in images" :key="index">
                        <img :src="image" 
                                ...
                                class="w-full h-72 object-cover transition-opacity duration-500">
                    </template>
                </div>
                ...
                <div class="absolute bottom-2 left-1/2 transform -translate-x-1/2 flex space-x-2">
                    <template x-for="(image, index) in images" :key="index">
                        <button @click="currentImage = index" 
                                :class="currentImage === index ? 'bg-blue-600' : 'bg-gray-400'"
